    ...
    <div className="min-h-screen bg-black text-white flex">
      ...
      <div className="w-64 bg-zinc-900 p-6">
        ...
        <nav className="space-y-4">
          ...
          <button onClick={() => navigate('/admin/seats')} className="w-full text-left p-4 hover:bg-zinc-800 rounded-xl font-bold">Ghế </button>
          <button onClick={() => navigate('/admin/stats')} className="w-full text-left p-4 hover:bg-zinc-800 rounded-xl font-bold">Doanh thu</button>
        </nav>
      </div>
